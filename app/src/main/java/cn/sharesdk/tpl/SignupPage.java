...
import com.freetrip.trekker.activities.MainActivity;
...
public class SignupPage extends FakeActivity implements OnClickListener,
	...
	public void onCreate() {
		...
		// 如果拿到了用户信息
		SpfUtils.setBoolean(getContext(), "is_login", true);
		SpfUtils.setString(getContext(), "user_name", userInfo.getUserName());
		SpfUtils.setString(getContext(), "user_icon", picturePath);
		SpfUtils.setString(getContext(), "user_gender",
				userInfo.getUserGender() == UserInfo.Gender.BOY ? "男" : "女");
		SpfUtils.setString(getContext(), "user_id", userInfo.getUserNote());

		Intent intent = new Intent(getContext(), MainActivity.class);
		MainActivity.currentMainActivity.finish();
		startActivity(intent);
		ToastUtils.show("登录成功，滑动查看");
